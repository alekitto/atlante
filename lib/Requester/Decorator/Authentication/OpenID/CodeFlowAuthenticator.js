 ...
 */
export default class CodeFlowAuthenticator extends BaseAuthenticator {
    /**
     * @inheritdoc
     */
    async startAuthorization(callbackUri, display = 'page', state = undefined) {
     ...
     */
    async authenticateFromCode(code, callbackUri) {
        this._tokenPromise = this._tokenPromise || (async () => {
            ...
            this._storeTokenFromResponse(response);
