import ClientTokenAuthenticator from './ClientTokenAuthenticator';
...
export default class TokenPasswordAuthenticator extends ClientTokenAuthenticator {
     ...
     * @param {string} [id_token_key = 'id_token']
     */
    constructor(
        requester,
        tokenStorage,
     ...
     * @protected
     */
    async _storeTokenFromResponse(response, requestType = 'request') {
        const item = await this._tokenStorage.getItem(this._accessTokenKey);
